          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-left">
              ...
              <Button 
                ...
                onClick={() => window.open('https://vintagemarqueelights.com/pages/custom-sign-request-form?prefill=%7B%22Field19%22%3A%22Rental%20Inventory%20Package%20Info%22%7D', '_blank')}
              >
