...
const ThreeDLogosThankYou = () => {
  ...
  useEffect(() => {
    trackMetaLeadOnce("3d-logos", entryId);
    trackLeadOnce("3d-logos", "3D Layered Logo Signs", entryId);
  }, [entryId]);
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Thank You - Vintage Marquee Lights</title>
        <meta name="description" content="Thank you for your 3D layered logo sign quote request. We'll follow up shortly." />
...
export default ThreeDLogosThankYou;
