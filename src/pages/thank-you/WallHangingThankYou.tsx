...
const WallHangingThankYou = () => {
  ...
  useEffect(() => {
    trackMetaLeadOnce("wall-hanging", entryId);
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta name="description" content="Thank you for your wall-hanging marquee sign quote request. We'll follow up shortly." />
...
export default WallHangingThankYou;
