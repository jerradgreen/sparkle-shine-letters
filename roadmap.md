...
- [ ] Replace the abbreviated `/3d-logos` proof with the full approved founder and Exit Zero sections directly after its gallery.
- [ ] Verify exact copy, all eight images, desktop/mobile order and overflow, metadata, and quote route without submission.
